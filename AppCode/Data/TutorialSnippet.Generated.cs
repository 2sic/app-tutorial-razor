...
namespace AppCode.Data
{
  ...
  /// </summary>
  public partial class TutorialSnippet: AutoGenerated.ZagTutorialSnippet
  {  }
}
...
namespace AppCode.Data.AutoGenerated
{
  ...
  /// </summary>
  public abstract class ZagTutorialSnippet: Custom.Data.CustomItem
  {
    /// <summary>
    ...
    /// <summary>
    /// Formula as single item of TutFormulaSample.
    /// </summary>
    /// <remarks>
    /// Generated to only return 1 child because field settings had Multi-Value=false. The type TutFormulaSample was specified in the field settings.
    /// </remarks>
    /// <returns>
    /// A single item OR null if nothing found, so you can use ?? to provide alternate objects.
    /// </returns>
    public TutFormulaSample Formula => _formula ??= _item.Child<TutFormulaSample>("Formula");
    private TutFormulaSample _formula;
    ...
    /// <summary>
    /// ToobarsForAnonymous as bool. <br/>
    /// To get nullable use .Get("ToobarsForAnonymous") as bool?;
    /// </summary>
    public bool ToobarsForAnonymous => _item.Bool("ToobarsForAnonymous");
