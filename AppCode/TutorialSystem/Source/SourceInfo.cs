...
namespace AppCode.TutorialSystem.Source
{
  internal class ShowSourceSpecs {
    ...
    {
      return $"{nameof(ShowSourceSpecs)} - Processed: {Processed}; Size: {Size}; Language: {Language}; Type: {Type}; DomAttribute: {DomAttribute}; RandomId: {RandomId}; ShowTitle: {ShowTitle}; Expand: {Expand}; Wrap: {Wrap}";
    }
  }
